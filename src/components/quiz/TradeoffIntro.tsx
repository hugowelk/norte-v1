...
export function TradeoffIntro({ onBegin }: Props) {
  return (
    ...
    >
      <p className="text-xs font-display uppercase tracking-widest text-accent">Part 2 of 3</p>
      ...
      <div className="space-y-4 text-base md:text-lg text-foreground/80 leading-relaxed">
        <p>
          You'll see 13 everyday situations. In each one, pick the option closest to how you'd <em>actually</em> act —
          not how you'd like to act.
        </p>
